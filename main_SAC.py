...
shoplistfile = 'E:/PycharmProjects/code/backup/path planning/MASAC_new1'  #保存文件数据所在文件的文件名
shoplistfile_test = 'E:/PycharmProjects/code/backup/path planning/MASAC_d_test2'  #保存文件数据所在文件的文件名
shoplistfile_test1 = 'E:/PycharmProjects/code/backup/path planning/MASAC_compare'  #保存文件数据所在文件的文件名
            ...
            for k in range(TRAIN_NUM):
                ...
                for episode in range(EP_MAX):
                    ...
                    if episode % 20 == 0 and episode > 200:#保存神经网络参数
                        ...
                        torch.save(save_data, "E:/PycharmProjects/code/backup/path planning/check/Path_SAC_env_L1.pth")
                        save_data = {'net': actors[1].action_net.state_dict(), 'opt': actors[1].optimizer.state_dict()}
                        torch.save(save_data, "E:/PycharmProjects/code/backup/path planning/check/Path_SAC_env_F1.pth")
