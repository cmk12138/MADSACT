...
def run(env):
    if Switch==0:
        ...
        print('SAC测试中...')
        aa = Actor()
        checkpoint_aa = torch.load("E:/PycharmProjects/code/backup/path planning/Path_SAC_actor_L1.pth")
        aa.action_net.load_state_dict(checkpoint_aa['net'])
        bb = Actor()
        checkpoint_bb = torch.load("E:/PycharmProjects/code/backup/path planning/Path_SAC_actor_F1.pth")
