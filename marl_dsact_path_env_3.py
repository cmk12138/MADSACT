...
def train(cfg: Config):
    ...
    try:
        ...
        plt.plot(total_arr, label="Total", linewidth=1.5, color='green')
        plt.plot(leader_arr, label="Leader", linewidth=1.5, color='blue')
        if follower_arr is not None:
            plt.plot(follower_arr, label="Follower", linewidth=1.5, color='red')
        ...
        save_single_curve(total_arr, "Total", "green", "reward_total_only.png", "Total Reward")
        save_single_curve(leader_arr, "Leader", "blue", "reward_leader_only.png", "Leader Reward")
        if follower_arr is not None:
            save_single_curve(follower_arr, "Follower", "red", "reward_follower_only.png", "Follower Reward")
        else:
